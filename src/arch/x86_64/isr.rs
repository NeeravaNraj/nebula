...
pub struct InterruptFrame {
    ...
    interrupt: u64, error_code: u64,
    rip: u64, cs: u64, rflags: u64, rsp: u64, ss: u64
}

#[allow(unused)]
#[unsafe(no_mangle)]
extern "C" fn isr_handler(frame: &InterruptFrame) {
    let mut message = "Unknown interrupt";
    let interrupt = frame.interrupt as usize;
    let exception_count = EXCEPTION_MESSAGES.len();

    if interrupt < exception_count && interrupt != 0x0F {
